...
## Summary
- 894 nodes · 1988 edges · 39 communities (34 shown, 5 thin omitted)
- Extraction: 82% EXTRACTED · 18% INFERRED · 0% AMBIGUOUS · INFERRED: 358 edges (avg confidence: 0.8)
- Token cost: 78,613 input · 673 output

## Graph Freshness
- Built from commit: `14f7914f`
...
- Disponibilidade Público API
- Web Lint & Agendamento API Client
- Rate Limit Interceptor
- Frontend Dev Dependencies
- Global Exception Handling
- Vitrine Pública Integration Tests
...
- `AgendamentoPublicoController` --references--> `AgendamentoService`  [EXTRACTED]
  backend/src/main/java/com/seusistema/barbearia/agendamento/AgendamentoPublicoController.java → backend/src/main/java/com/seusistema/barbearia/agendamento/AgendamentoService.java
- `AgendamentoPublicoController` --references--> `BarbeiroService`  [EXTRACTED]
  backend/src/main/java/com/seusistema/barbearia/agendamento/AgendamentoPublicoController.java → backend/src/main/java/com/seusistema/barbearia/barbeiro/BarbeiroService.java
...
Cohesion: 0.05
Nodes (38): Agendamento, Entity, Table, AgendamentoController, GetMapping, PostMapping, RequestMapping, RestController (+30 more)

### Community 1 - "Cliente Barbeiro Servico Entities"
Cohesion: 0.06
Nodes (19): Barbeiro, Entity, Table, StatusConta, ATIVO, INATIVO, Cliente, Entity (+11 more)

### Community 2 - "Disponibilidade Público API"
Cohesion: 0.06
Nodes (31): AgendamentoPublicoController, DisponibilidadeDTO, GetMapping, RequestMapping, RestController, AgendamentoRepository, DisponibilidadeService, Service (+23 more)

### Community 3 - "Web Lint & Agendamento API Client"
Cohesion: 0.08
Nodes (35): oxc, react, typescript, warn, plugins, rules, react/only-export-components, react/rules-of-hooks (+27 more)
...
### Community 7 - "Vitrine Pública Integration Tests"
Cohesion: 0.09
Nodes (20): ActiveProfiles, BeforeEach, Test, TestRestTemplate, VitrinePublicaTest, ContextLoadsTest, Test, FixturaPadrao (+12 more)

### Community 8 - "Horário Funcionamento DTOs & Repo"
Cohesion: 0.10
Nodes (14): ExcecaoHorarioDTO, HorarioFuncionamentoDTO, ExcecaoHorarioRepository, HorarioController, DeleteMapping, GetMapping, PostMapping, PutMapping (+6 more)
...
Cohesion: 0.12
Nodes (14): SalvarServicoRequest, DeleteMapping, GetMapping, PostMapping, PutMapping, RequestMapping, ResponseStatus, RestController (+6 more)
...
Cohesion: 0.21
Nodes (6): SalvarExcecaoRequest, SalvarHorarioRequest, HorarioCrudTest, BeforeEach, HttpHeaders, Test
...
### Community 18 - "Disponibilidade Service Tests"
Cohesion: 0.22
Nodes (6): DisponibilidadeDTO, DisponibilidadeTest, BeforeEach, Import, ResponseEntity, Test

### Community 19 - "Caixa & Forma Pagamento"
Cohesion: 0.19
Nodes (8): CaixaController, GetMapping, RequestMapping, RestController, CaixaService, Service, Transactional, CaixaDTO

### Community 20 - "Barbeiro Login Controller"
Cohesion: 0.15
Nodes (5): BarbeiroController, PostMapping, RequestMapping, RestController, LoginResponse

### Community 21 - "Autenticação Tests"
Cohesion: 0.25
Nodes (5): LoginRequest, AutenticacaoTest, BeforeEach, Test, TestRestTemplate
...
Cohesion: 0.18
Nodes (6): BarbeiroPublicoController, GetMapping, RequestMapping, RestController, BarbeiroPublicoDTO, BarbeiroPublicoDTO

### Community 24 - "BarbeiroService Tests"
Cohesion: 0.27
Nodes (4): CriarBarbeiroRequest, BarbeiroServiceTest, PasswordEncoder, Test

### Community 25 - "BarbeiroService Criação"
Cohesion: 0.29
Nodes (4): BarbeiroService, PasswordEncoder, Service, Transactional
...
## Knowledge Gaps
- **146 isolated node(s):** `com.seusistema:barbearia`, `PIX`, `DINHEIRO`, `DEBITO`, `CREDITO` (+141 more)
...
- **Why does `BarbeiroService` connect `BarbeiroService Criação` to `Agendamento Domain Model`, `Disponibilidade Público API`, `Rate Limit Interceptor`, `Vitrine Pública Integration Tests`, `Serviço CRUD Controller`, `Security Config & JWT Filter`, `Horário CRUD Requests & Tests`, `Barbeiro Login Controller`, `Autenticação Tests`, `Barbeiro Público Controller`, `BarbeiroService Tests`, `Runner Criação Barbeiro Inicial`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Why does `IntegrationTestBase` connect `Vitrine Pública Integration Tests` to `Agendamento Domain Model`, `Cliente Barbeiro Servico Entities`, `Disponibilidade Público API`, `Rate Limit Interceptor`, `Horário Funcionamento DTOs & Repo`, `Serviço CRUD Controller`, `HorarioFuncionamento Entity`, `Horário CRUD Requests & Tests`, `Disponibilidade Service Tests`, `Autenticação Tests`, `BarbeiroService Tests`, `BarbeiroService Criação`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Why does `RegraDeNegocioException` connect `Agendamento Domain Model` to `Disponibilidade Público API`, `Global Exception Handling`, `Horário Funcionamento DTOs & Repo`, `HorarioFuncionamento Entity`, `ExcecaoHorario Entity`, `Caixa & Forma Pagamento`?**
